...
final class ApiClientTest extends LettrTestCase {
	...
	public static function endpointProvider(): array {
		return array(
			...
			'bulk_create_flat'      => array( 'bulk_create_audience_contacts', array( array( 'emails' => array( 'a@b.c' ) ) ), 'POST', '/audience/contacts/bulk', array( 'emails' => array( 'a@b.c' ) ) ),
			'bulk_create_rows'      => array( 'bulk_create_audience_contacts', array( array( 'contacts' => array( array( 'email' => 'a@b.c', 'topics' => array( array( 'id' => 't1', 'subscription' => 'opt_out' ) ) ) ), 'update_existing' => true ) ), 'POST', '/audience/contacts/bulk', array( 'contacts' => array( array( 'email' => 'a@b.c', 'topics' => array( array( 'id' => 't1', 'subscription' => 'opt_out' ) ) ) ), 'update_existing' => true ) ),
			'bulk_sub_topics'       => array( 'bulk_subscribe_audience_contacts_to_topics', array( array( 'contact_ids' => array( 'c1' ), 'topic_ids' => array( 't1' ) ) ), 'POST', '/audience/contacts/topics/bulk', array( 'contact_ids' => array( 'c1' ), 'topic_ids' => array( 't1' ) ) ),
			'bulk_unsub_topics'     => array( 'bulk_unsubscribe_audience_contacts_from_topics', array( array( 'contact_ids' => array( 'c1' ), 'topic_ids' => array( 't1' ) ) ), 'DELETE', '/audience/contacts/topics/bulk', array( 'contact_ids' => array( 'c1' ), 'topic_ids' => array( 't1' ) ) ),
